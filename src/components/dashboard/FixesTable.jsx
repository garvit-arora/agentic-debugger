        ...
        <table className="w-full text-left border-collapse min-w-[1000px]">
          <thead>
            <tr className="bg-white/[0.03] border-b border-white/[0.10]">
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/50">
                File Path
              </th>
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/50">
                Bug Type
              ...
              <th className="px-6 py-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/50 text-right">
                Actions
              </th>
            </tr>
          </thead>
                ...
                <tr
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[12px] font-medium text-white/80 group-hover:text-white transition-colors truncate max-w-xs">
                        {fix.file}
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-2 group/msg">
                      <span className="text-[11px] text-white/60 group-hover/msg:text-white/90 transition-colors italic truncate max-w-sm">
                        "{fix.commitMessage}"
                      </span>
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4 text-right">
                    <button className="p-2 hover:bg-white/10 rounded-sm transition-colors text-white/40 hover:text-white">
                      <Maximize2 size={14} />
                    </button>
                  </td>
                </tr>
